...
def print_generation(gen: int, result: EvalResult, archive: GridArchive) -> None:
    ...
    table.add_row("Archive size", str(len(archive)))
...
def print_results(archive: GridArchive, decode_fn, top_n: int = 10) -> None:
    ...
    console.print(f"Archive size: {len(archive)}")
    ...
    order, solutions, smiles = _rank_archive(archive, decode_fn, top_n)
